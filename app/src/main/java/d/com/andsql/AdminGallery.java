...
public class AdminGallery extends AppCompatActivity {
    ...
    ImageView img;
    String Storage_Path = "All_Contact_Image_Uploads/";
...
//        udesign=findViewById(R.id.cdesign);
        ...
        progressDialog = new ProgressDialog(AdminGallery.this);
...
//                            String desi = udesign.getText().toString();
                            ...
                            Contact contact = new Contact(downloadUrl.toString());
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(AdminGallery.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AdminGallery.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
